...
<head>
	<meta charset="utf-8">
	<title>SACP - Sys Alpha Code Pedidos</title>
...
<header class="alert alert-secondary">
	...
	<nav style="text-align: center;"> 
		...
		<a href="../pedidos/pg_painel_pedidos.php" class="btn btn-outline-secondary form_menu" id="pos_menu">
		<img src="../../img/icones/icones_menu/icone_pedidos.png" width="50px" height="50px"> <br>		
			<b>Pedidos</b></a>	
			
		<a href="../produtos/pg_painel_produtos.php" class="btn btn-outline-secondary  id="pos_menu">
...
border-radius: 20px; padding: 10px; text-align: center;" class="alert alert-secondary">
		...
		<h2 style="text-align: center;">Clientes</h2> <hr>

		<a href="../clientes/form_cadastro_cliente.php" class="btn btn-outline-secondary form_menu" id="pos_menu">
		<img src="../../img/icones/icones_painel/icone_cadastro.png" width="50px" height="50px"> <br>	
		<b>Cadastro</b></a>

		<a href="form_consultas_clientes.php" class="btn btn-outline-secondary form_menu" id="pos_menu">
		<img src="../../img/icones/icones_painel/icone_consultas.png" width="50px" height="50px"> <br>	
		<b>Consultas</b></a>

		<a href="form_relatorios_clientes.php" class="btn btn-outline-secondary form_menu" id="pos_menu">
		<img src="../../img/icones/icones_painel/icone_relatorios.png" width="50px" height="50px"> <br>	
		<b>Relatórios</b></a>
		
		<a href="form_alterar_apagar_cad_clientes.php" class="btn btn-outline-secondary form_menu" id="pos_menu">
		<img src="../../img/icones/icones_painel/icone_relatorios.png" width="50px" height="50px"> <br>	
