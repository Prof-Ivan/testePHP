...
border-radius: 20px; padding: 10px; text-align: center;" class="alert alert-secondary">
		...
		<h2 style="text-align: center;">Produtos</h2> <hr>

		<a href="form_cadastro_produto.php" class="btn btn-outline-secondary form_menu" id="pos_menu">
		<img src="../../img/icones/icones_painel/icone_cadastro.png" width="50px" height="50px"> <br>	
		<b>Cadastro</b></a>

		<a href="form_consultas_produtos.php" class="btn btn-outline-secondary form_menu" id="pos_menu">
		<img src="../../img/icones/icones_painel/icone_consultas.png" width="50px" height="50px"> <br>	
		<b>Consultas</b></a>

		<a href="form_relatorios_produtos.php" class="btn btn-outline-secondary form_menu" id="pos_menu">
		<img src="../../img/icones/icones_painel/icone_relatorios.png" width="50px" height="50px"> <br>	
		<b>Relatórios</b></a>
		
		<a href="form_alterar_apagar_cad_produtos.php" class="btn btn-outline-secondary form_menu" id="pos_menu">
		<img src="../../img/icones/icones_painel/icone_relatorios.png" width="50px" height="50px"> <br>	
