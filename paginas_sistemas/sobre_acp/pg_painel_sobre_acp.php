...
border-radius: 20px; padding: 10px; text-align: center;" class="alert alert-secondary">
		...
		<h2 style="text-align: center;">Sobre o ACP</h2> <hr>

		<a href="../../conexao_bd_mysql/teste_conexao_bd_mysql.php" class="btn btn-outline-secondary form_menu" id="pos_menu">
		<img src="../../img/icones/icones_painel/icone_bd.png" width="50px" height="50px"> <br>	
		<b>Teste com BD</b></a>

		<a href="pg_sobre_acp.php" class="btn btn-outline-secondary form_menu" id="pos_menu">
		<img src="../../img/icones/icones_painel/icone_sobre_acp.png" width="50px" height="50px"> <br>	
		<b>Conheça o ACP</b></a>
