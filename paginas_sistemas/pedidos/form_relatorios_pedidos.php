...
<header>
	...
	<h1 class="alert alert-secondary" role="alert" 
		style="margin: 0px; text-align: center; padding: 13px; top: 10px;">Relatórios de Pedidos
	</h1>
    ...
    <nav style="margin: 0px; padding: 5px; position: relative; top:-60px;">
		...
		<a href="form_relatorios_pedidos.php"  class="btn btn-outline-secondary" title="Atualizar relatório">
...
// Relatório incial
$sql = "SELECT * FROM tb_pedido order by ped_codigo desc limit 20"; 
